...
const Product = () => {
  ...
  const fetchProductData = async () => {
    const seletedProduct = products.find((item) => item._id === productId);

    if (seletedProduct) {
      setProduct(seletedProduct);
      setImage(seletedProduct.image[0]);
      ...
      <div className="max-padd-container ">
        ...
        <div className="flex gap-12 flex-col xl:flex-row bg-primary  rounded-2xl p-3 mb-6">
          ...
          <div className="flex flex-1 gap-x-2 xl:flex-1">
            ...
            <div className=" h-[377px] w-auto flex ">
              <img
                src={image}
                alt="productImg"
          ...
          <div className="flex-[1.5] rounded-2xl xl:px-7">
            ...
            <div className="mt-2 flex flex-col gap-1 text-gray-30 text-[14px]">
              ...
              <p>Delivery to your Door step</p>
              <p>Enjoy cash On Your Convenience</p>
            </div>
          </div>
        </div>
        <ProductDescription />
