  ...
  return (
    <div className="ring-1 ring-slate-900/10 rounded-lg">
      <div className="flex-gap-3">
        ...
        <button className="medium-14 p-3 w-32 border-b-2 ">
          Care Guide
        </button>
        <button className="medium-14 p-3 w-32 border-b-2">
          Size Guide
      ...
      <div className="flex flex-col gap-3 p-3">
        <div>
          ...
          <p className="text-sm">
            ...
            quam, repudiandae cum placeat adipisci laborum id dicta suscipit
            tempore saepe consequuntur, molestias odit iusto quos ullam, hic
            modi tempora?
          </p>
          <p className="text-sm">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fugiat at
            quam, repudiandae cum placeat adipisci laborum id dicta suscipit
            tempore saepe consequuntur, molestias odit
          </p>
        </div>
        <div>
          ...
          <ul className='list-disc pl-5 text-sm text-gray-30 flex flex-col gap-1'>
            ...
            <li>Designed to meet the needs of mordern, active lifestyle.</li>
